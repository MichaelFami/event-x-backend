  ...
  const events = [
    {
     ...
     },
        {
            ...
            description: "Community members gather to donate non-perishable food items.",
        ...
        },
        {
            ...
            description: "A festive event where toys are collected for underprivileged children.",
        ...
        },
        {
            ...
            description: "Supporters come together to fundraise for clean water initiatives.",
        ...
        },
        {
            ...
            description: "Collecting winter clothing for those in need during the cold season.",
        ...
        },
        {
            ...
            description: "Environmental enthusiasts contribute to tree-planting initiatives.",
        ...
        {
            name: "Tech for All",
            description: "Gathering used electronics to be refurbished for educational purposes.",
